...
def path_for(train=False, val=False, test=False, question=False, answer=False, prefix = ''):
    ...
    if train:
        ...
        pre = 'real_iv'
    if question:
        fmt = pre + '/{3}_{0}_{1}_{2}_questions.json'
    else:
        fmt = pre + '/{3}_{1}_{2}_annotations.json'
